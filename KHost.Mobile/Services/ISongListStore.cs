...
public interface ISongListStore
{
    ...
    /// <summary>Add a new wishlist entry. Title is required; artist/notes optional.</summary>
    Task<SongListItem> AddAsync(string title, string artist, string? notes = null);
