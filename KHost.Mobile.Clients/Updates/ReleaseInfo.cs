...
/// <summary>A single published GitHub release, projected to the fields the update check needs.</summary>
...
/// <param name="HtmlUrl">The release's page on github.com.</param>
