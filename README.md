...
- **My Songs** — a personal wishlist of songs to sing, as swipeable cards. Add with the floating **+**, search titles and artists from a box that **stays pinned as you scroll**, filter by genre, tags, year or rating, and sort your way — everything stays put as you switch tabs and come back. One tap on a card queues a song for tonight.
...
- **Import & export** — export a singer's whole profile (songs *and* sung history) to a file for backup or to move them to another device, export/import your venue list separately, or pull songs straight in from a public **Spotify** or **YouTube Music** playlist link.
