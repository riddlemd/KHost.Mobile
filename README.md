...
- **Spelling check** — if the lookup finds no exact match but something one slip away, the card gets a ⚠ and the song's detail sheet asks *"Did you mean Bohemian Rhapsody — Queen?"*. Take the correction with one tap and the year, genre and cover fill in behind it; wave it off and it never asks again.
